...
def testperf(agent_name1, agent1, agent_name2, agent2):
    ...
    config.register_player(name='zacci', algorithm=ZacciPlayer())
...
def parse_arguments():
    ...
    parser.add_argument('-n1', '--agent_name1', help="Name of agent 1", default="Opponent", type=str)
    parser.add_argument('-a1', '--agent1', help="Agent 1", default=RandomPlayer())
    parser.add_argument('-n2', '--agent_name2', help="Name of agent 2", default="Zacci", type=str)
